function nextStepPixels = maskPixels2(image)
...
hueMember1 = zeros(480,640);
hueMember2 = zeros(480,640);
hueMember3 = zeros(480,640);
...
hueMember1Count = imfilter(double(hueMember1),ones(10))./(10^2);
hueMember2Count = imfilter(double(hueMember2),ones(10))./(10^2);
hueMember3Count = imfilter(double(hueMember3),ones(10))./(10^2);

% Erase everywhere there is a 0 in at least one of the members and
% threshold
caca = hueMember1Count.*hueMember2Count + ...
